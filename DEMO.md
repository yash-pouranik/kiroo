...
**Killer part:** AI summary explains practical break risk, plus request/response drift, enum drift, required-field breaks, localized impact, and migration hints.
